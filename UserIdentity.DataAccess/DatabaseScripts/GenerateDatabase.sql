USE [master]
GO
/****** Object:  Database [UserIdentityDb]    Script Date: 4/22/2017 6:43:08 PM ******/
CREATE DATABASE [UserIdentityDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UserIdentityDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\UserIdentityDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'UserIdentityDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\UserIdentityDb_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [UserIdentityDb] SET COMPATIBILITY_LEVEL = 130
GO
...
GO
ALTER DATABASE [UserIdentityDb] SET  DISABLE_BROKER 
GO
...
GO
ALTER DATABASE [UserIdentityDb] SET READ_COMMITTED_SNAPSHOT OFF 
GO
